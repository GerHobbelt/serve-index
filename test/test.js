      ...
      it('should sort folders first', function(done) {
        ...
        request(server)
          ...
          .end(function(err, res) {
            ...
            var urls = body.split(/<a href="([^"]*)"/).filter(function(s, i) {
              return i % 2
            })
...
function createServer(dir, opts) {
  ...
  var _serveDirectory = serveDirectory(dir, opts)

  return http.createServer(function(req, res) {
    _serveDirectory(req, res, function(err) {
